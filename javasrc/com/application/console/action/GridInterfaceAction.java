 ...
 * @version 1.0
 */
public class GridInterfaceAction extends SupportAction{
	
	
	public String getGridInterfaceBase(){
	...
	public String saveGridInterfaceBase(){
		String resourceName=this.getActionContext().get("resourceName");
		String interfaceKey=this.getActionContext().get("interfaceKey");
		...
		return this.getGridInterfaceBase();
	}
