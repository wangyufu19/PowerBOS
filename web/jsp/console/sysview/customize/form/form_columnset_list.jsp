	...
	<div class="box">		
		<div class="tabContent">
			...
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveFormColumnSetList.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
								...
								<tbody>
								  <s:iterator id="columnSet" name="columnSets" status="st">   								      
							        ...
							        >			
							            ...
							            <input id="id" name="id" type="radio" value="<s:write name="columnSet" property="key"/>" size="16" class="text" onclick="javascript:loadColumnSetAtt('<%=contextPath%>/jsp/console/getFormColumnSetAtt.action?resourceName=<s:write property="resourceName"/>&pageKey=<s:write property="pageKey"/>&pageCode=<s:write property="pageCode"/>&columnKey=<s:write name="columnSet" property="key"/>');"/>
							            </td> 				           
...
window.onload=function(){
	parent.iframe2.location.href="<%=contextPath%>/jsp/console/getFormColumnSetAtt.action?resourceName=<s:write property="resourceName"/>&pageKey=<s:write property="pageKey"/>&pageCode=<s:write property="pageCode"/>&columnKey=";
}
