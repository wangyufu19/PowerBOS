	...
	<div class="box">		
		<div class="tabContent">
			<ul id="tabmenu" class="tabmenu">	
			    ...
			    <li id="tab3"><a href="getFormStatementInput.action?resourceName=<s:write property="resourceName"/>&pageKey=<s:write property="pageKey"/>&pageCode=<s:write property="pageCode"/>&statementKey=<s:write property="statementKey"/>">输入参数</a></li>				   				
			</ul>
			...
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveFormStatementBase.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
