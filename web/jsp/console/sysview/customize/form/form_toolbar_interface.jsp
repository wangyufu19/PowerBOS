	...
	<div class="box">		
		<div class="tabContent">
			<ul id="tabmenu" class="tabmenu">				   
			    ...
			    <li id="tab3"><a href="<%=contextPath%>/jsp/console/getFormToolbarInput.action?resourceName=<s:write property="resourceName"/>&toolbarKey=<s:write property="toolbarKey"/>">输入参数</a></li>	
			    <li id="tab4" class="select"><a href="#">外部接口</a></li>
			...
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button id="save" disabled="disabled" class="btn-able" onclick="javascript:doWith_f(submitF,'saveFormToolbarInterface.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
