	...
	<div class="box">		
		<div class="tabContent">
			...
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveGridStatementBase.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
					...
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >						   
							...
							<tr class="TrOdd">		
							    <td><b>returnClass:</b></td>								
								<td colspan="2">
								<input id="returnClass" name="returnClass" type="text" value="<s:write property="returnClass"/>" size="40" class="text"/>								
								</td>										
							</tr>
							<tr class="TrEven">		
							    <td><b>resultMap:</b></td>								
								<td colspan="2">
								<input id="resultMap" name="resultMap" type="text" value="<s:write property="resultMap"/>" class="text"/>								
								</td>										
							</tr>																																						
						</table>	
					</div>
