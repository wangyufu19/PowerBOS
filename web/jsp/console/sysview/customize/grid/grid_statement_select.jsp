	...
	<div class="box">		
		<div class="tabContent">
			<ul id="tabmenu" class="tabmenu">	
			    ...
			    <li id="tab2" class="select"><a href="#">基本语句</a></li>	
			    ...
			    <li id="tab4"><a href="getGridStatementOrderby.action?resourceName=<s:write property="resourceName"/>&pageKey=<s:write property="pageKey"/>&pageCode=<s:write property="pageCode"/>&statementKey=<s:write property="statementKey"/>">排序语句</a></li>		
			...
			<form name="submitF" action="" method="post">					
			   ...
			   <input id="selectKey" name="selectKey" type="hidden" value="<s:write property="selectKey"/>"/>
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveGridStatementSelect.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
					...
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >						   
							<tr class="TrEven">	
							    <td><b>基本语句:</b></td>										
								<td colspan="3">
								<textarea id="selectText" name="selectText" class="text" rows="10" cols="80"><s:write property="selectText"></s:write></textarea>								
								</td>										
							</tr>																																							
						</table>	
					</div>
