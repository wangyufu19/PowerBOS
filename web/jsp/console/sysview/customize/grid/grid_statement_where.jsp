	...
	<div class="box">		
		<div class="tabContent">
			<ul id="tabmenu" class="tabmenu">	
			    ...
			    <li id="tab3" class="select"><a href="#">条件语句</a></li>
			    <li id="tab3"><a href="getGridStatementOrderby.action?resourceName=<s:write property="resourceName"/>&pageKey=<s:write property="pageKey"/>&pageCode=<s:write property="pageCode"/>&statementKey=<s:write property="statementKey"/>">排序语句</a></li>		
			    <li id="tab4"><a href="getGridStatementInput.action?resourceName=<s:write property="resourceName"/>&pageKey=<s:write property="pageKey"/>&pageCode=<s:write property="pageCode"/>&statementKey=<s:write property="statementKey"/>">输入参数</a></li>				   				
			</ul>
			...
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveGridStatementWhere.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
					...
					<div class="listform">
						...
						<div class="listInner">
							...
							<table id="L0" width="100%" cellpadding="0" cellspacing="0" border="0" >
								...
								<tbody>
								  <s:iterator id="where" name="wheres" status="st">   								      
							        <tr
							        ...
							        >		
										...
										<td><input id="loadCondition" name="loadCondition"  type="text" value="<s:property name="where" value="key"/>" size="32" class="text"/></td>	
										<td><input id="whereText" name="whereText"  type="text" value="<s:property name="where" value="value"/>" size="32" class="text"/></td>																										     		
									</tr>
								  </s:iterator>
								</tbody>
							</table>	
...
function addLine_f(){
  ...
  if(rows>=1){
     ...
     td.innerHTML="<input id=\"loadCondition\" name=\"loadCondition\"  type=\"text\" value=\"\" size=\"32\" class=\"text\"/>";
      var td=tr.insertCell(2);
     td.innerHTML="<input id=\"whereText\" name=\"whereText\"  type=\"text\" value=\"\" size=\"32\" class=\"text\"/>";
  }
}
</script>
</body>	
