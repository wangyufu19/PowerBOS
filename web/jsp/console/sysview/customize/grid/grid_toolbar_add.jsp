	...
	<div class="box">		
		<div class="tabContent">
			...
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button id="save" disabled="disabled" class="btn-able" onclick="javascript:doWith_f(submitF,'addGridToolbar.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
					...
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >	
						    <tr class="TrEven">
								<td><b>动作编码:</b></td>							
								<td colspan="2"><input name="actionCode" type="text" value="" size="32" class="text"/></td>										
							</tr>
							<tr class="TrEven">
								<td><b>动作名称:</b></td>							
								<td colspan="2"><input name="actionName" type="text" value="" size="32" class="text"/></td>										
							</tr>				
							<tr class="TrEven">
								<td><b>动作类型:</b></td>							
								<td colspan="2"><input name="actionType" type="text" value="" size="32" class="text"/></td>										
							</tr>	   
							<tr class="TrEven">
								<td><b>加载条件:</b></td>							
								<td colspan="2"><input name="loadCondition" type="text" value="" size="32" class="text"/></td>										
							</tr>		
							<tr class="TrOdd">
								<td><b>执行类型:</b></td>							
								<td colspan="2">
								<select name="executeType">
						  			...
						  			<option value="statement">SQL语句</option>		
						  			<option value="interface">外部接口</option>						  
								</select>	
							    </td>
							</tr>					
							<tr class="TrEven">
								<td><b>链接事件:</b></td>							
								<td colspan="2">
								<textarea name="href" rows="3" cols="50" class="text"></textarea>
								</td>										
							</tr>
							<tr class="TrOdd">
								<td><b>单击事件:</b></td>							
								<td colspan="2">
								<textarea name="onclick" rows="3" cols="50" class="text"></textarea>
								</td>										
							</tr>																
						</table>
					</div>	
