	...
	<div class="box">		
		<div class="tabContent">
			<ul id="tabmenu" class="tabmenu">	
			    <li id="tab1" class="select"><a href="#">脚本内容</a></li>				   
			</ul>
			<form name="submitF" action="" method="post">					
               ...
               <input id="scriptKey" name="scriptKey" type="hidden" value="<s:write property="scriptKey"/>"/>
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveScriptObjectContent.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
					...
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >						   
							<tr class="TrEven">								    					
								<td colspan="5">
								<textarea id="scriptText" name="scriptText" class="text" rows="20" cols="94"><s:write property="scriptText"></s:write></textarea>								
								</td>										
							</tr>																																							
						</table>	
					</div>
