	...
	<div class="box">		
		<div class="tabContent">
			...
			<form name="submitF" action="" method="post">					
			   ...
			   <input id="searchKey" name="searchKey" type="hidden" value="<s:write property="searchKey"/>"/>
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'saveSearchObjectBase.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
					...
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr class="TrEven">
								...
								<td colspan="2">
								<input name="searchTitle" id="searchTitle" type="text" value="<s:write property="searchTitle"/>" size="32" class="text" />
								</td>
						    </tr>						   
							<tr class="TrOdd">
								<td>
