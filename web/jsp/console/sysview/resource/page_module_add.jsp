...
<script language="JavaScript" type="text/javascript" src="<%=contextPath%>/lib/console/js/layout/window.js"></script>
	...
	<div class="box">		
		<div class="tabContent">
			<ul id="tabmenu" class="tabmenu">	
			    <li id="tab1" class="select"><a href="#">页面模块</a></li>						
			</ul>
			...
			<div class="innerBox" id="tab1_content">
				<div class="innerBox1">		
				    <div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'addPageModule.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
						<button class="btn-able" onclick="javascript:doBack_f(submitF,'getPageModuleList.action');">返回</button>
					</div>				   				
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >								
							<tr class="TrEven">
								<td><b>模块名称:</b></td>							
								<td colspan="2"><input id="moduleName" name="moduleName" type="text" value="" size="32" class="text" check="string(64),nn,模块名称"/><span class="star">*</span></td>										
							</tr>
							<tr class="TrOdd">
								<td><b>资源名称:</b></td>							
								<td colspan="2"><input id="disResourceName" name="disResourceName" type="text" value="" size="32" class="text" disabled="disabled" check="string(64),nn,资源名称"/>&nbsp;&nbsp;<a href="javascript:winopen700('<%=contextPath%>/jsp/console/widget/resource/page_resource_select.jsp')">选择</a><span class="star">*</span></td>		
							</tr>																						
						</table>
					</div>
					<div class="btnt">
