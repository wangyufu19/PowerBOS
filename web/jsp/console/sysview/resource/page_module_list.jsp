...
<div class="container">	
	<div class="box">		
		<div class="tabContent">
			...
			<form name="submitF" action="showFormFile.action" method="post">				   
			<div class="innerBox" id="tab1_content">			  
				<div class="innerBox1">							
					<div class="btnt">
						<button id="add" class="btn-able" onclick="javascript:doWith_f(submitF,'getAddPageModule.action');">新增</button>&nbsp;&nbsp;
						<button id="delete" class="btn-able" disabled="disabled" onclick="javascript:doWith_f(submitF,'deletePageModule.action','您确定要删除吗?');">删除</button>&nbsp;&nbsp;
					</div>
					<div class="listform">
						...
						<div class="listInner">
							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0" >
								...
								<tbody>
								  <s:iterator id="pageModule" name="pageModules" status="st">   								      
							        <tr
							        ...
							        >				
							            <td><input id="id" name="id" type="checkbox" value="<s:write name="pageModule" property="key"/>" class="text" onclick="javascript:enable_f('id');"/></td> 					       																    
									  	<td><a href="getUpdatePageModule.action?key=<s:write name="pageModule" property="key"/>"><s:write name="pageModule" property="moduleName"/></a></td>										
										<td><s:write name="pageModule" property="resourceName"/></td>															     		
									</tr>
								  </s:iterator>
								</tbody>
							</table>	
