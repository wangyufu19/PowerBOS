	...
	<div class="box">		
		<div class="tabContent">
			...
			<div class="innerBox" id="tab1_content">
				<div class="innerBox1">		
				    <div class="btnt">
						<button class="btn-able" onclick="javascript:doWith_f(submitF,'addPageResource.action','您确定要保存吗?');">保存</button>&nbsp;&nbsp;
						<button class="btn-able" onclick="javascript:doBack_f(submitF,'getPageResourceList.action');">返回</button>
					</div>				   				
					<div class="detailForm">				
						<table width="100%" cellpadding="0" cellspacing="0" border="0" >						   
							<tr class="TrEven">
								<td><b>资源名称:</b></td>							
								<td colspan="2"><input name="resourceName" type="text" value="" size="32" class="text" check="string(64),nn,资源名称"/><span class="star">*</span></td>										
							</tr>																									
						</table>
					</div>
					<div class="btnt">
