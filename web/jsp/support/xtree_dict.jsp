...
<%@ page import="com.application.support.biz.DataDictBiz" %>
...
try{
	...
	biz.setReh(reh);
	List list=biz.getChildDataDict(parentId);
	...
	for(int i=0;i<list.size();i++){
		 ...
		 treeNode.setIsleaf(String.valueOf(obj[3]));
		 treeNode.setTarget("dtable");
		 treeNode.setSrc(contextPath+"/jsp/support/getChildDataDictTree.action?CODE="+CODE+"&parentId="+treeNode.getId()+"&target="+treeNode.getTarget());
