...
<%@ page import="com.application.support.biz.FunMgrBiz" %>
...
try{
	...
	biz.setReh(reh);
	List list=biz.getChildFunList(parentId);
	...
	for(int i=0;i<list.size();i++){
		 ...
		 treeNode.setSrc(contextPath+"/jsp/support/getChildFunTree.action?CODE="+CODE+"&parentId="+treeNode.getId()+"&target="+treeNode.getTarget());
