...
\----------------------------------------------------------------------------*/
var path = "/lib/console/images/xtree/";
...
function WebFXTree(sText, sAction, sBehavior, sIcon, sOpenIcon,sTarget) {
	this.target = sTarget;
...
function changeModel_f(){
    return;
	if(!window.confirm("您确定要"+document.getElementById("changeModel").innerHTML)) return;
		buffalo.remoteCall("AdpService.changeModel", [], dealChangeModel);
}
/*
 * WebFXTreeItem class
 */
