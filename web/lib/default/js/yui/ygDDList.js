...
ygDDList.prototype.startDrag = function(x, y) {
	...
	//dragEl.className = "moduleFrameDragging";
	//dragEl.style.color = clickEl.style.color;
	dragEl.style.border = "0";//拖拽中的状态
	...
	this.borderDiv.className = "moduleFrameHighLight";
	//this.borderDiv.style.border = '2px dashed #cccccc';//热区的状态－红色虚线框效果
...
ygDDList.prototype.endDrag = function(e) {
	...
	if(this.clickBorder) 
		...
		//clickEl.style.border = '4px solid #FF6600';
		clickEl.className = 'noBullet';//拖拽后的效果
